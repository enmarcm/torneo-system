import { AppBar, Toolbar, Box, Typography, Stack, IconButton, Menu, MenuItem, Avatar, Tooltip, Select, FormControl, MenuItem as MuiMenuItem, useTheme, useMediaQuery } from '@mui/material';
